...
<section class="section">
  ...
  <div class="stack">
    <div class="card"><div class="formula">\[\text{若 } f \text{ 在单连通区域 } D \text{ 内解析，且 } \gamma\subset D \text{ 为闭路，则 } \oint_\gamma f(z)\,dz=0\]</div><p>这是从“解析性”走向“积分理论”的第一步，但要记得它还依赖闭路与区域条件。</p></div>
...
<section class="section"><div class="section-head"><div><div class="kicker">典型例题</div><h2>典型例题</h2><p class="intro">先做这种地基题，后面的章节会顺很多。</p></div><div class="badge">典型例题</div></div><div class="example-grid"><article class="card example-card"><div class="kind exam">例题 A</div><h3>已知 <span class="math-inline">\(z=1-\sqrt{3}i\)</span>，求 <span class="math-inline">\(|z|\)</span> 与主辐角</h3><p class="tagline">先看坐标，再看象限。</p><div class="formula">\[|z|=\sqrt{1^2+(\!-\sqrt{3})^2}=2\]</div><div class="formula">\[\operatorname{Arg} z=-\frac{\pi}{3}\]</div><ol class="solution-list"><li>点 <span class="math-inline">\((1,-\sqrt{3})\)</span> 位于第四象限。</li><li>参考角满足 <span class="math-inline">\(\tan\theta=-\sqrt{3}\)</span>。</li><li>主辐角 <span class="math-inline">\(\operatorname{Arg} z\)</span> 取 <span class="math-inline">\(( -\pi,\pi ]\)</span> 中的值，所以 <span class="math-inline">\(\operatorname{Arg} z=-\pi/3\)</span>。</li></ol></article><article class="card example-card"><div class="kind exam">例题 B</div><h3>区域 <span class="math-inline">\(0&lt;|z|&lt;1\)</span> 是否单连通？</h3><p class="tagline">看有没有“洞”。</p><p>答案：<strong>不是</strong>。</p><ol class="solution-list"><li>这个区域是去掉原点的单位圆盘。</li><li>围绕原点的闭路无法在区域内部缩成一点。</li><li>因此它不是单连通区域。</li></ol></article></div></section>
''',
    ),
    "analytic.html": page(
        "analytic.html",
...
<section class="section"><div class="section-head"><div><div class="kicker">第 3 节</div><h2>调和函数与保角映射</h2><p class="intro">这两部分经常作为解析函数的推论出现，尤其在证明题和概念题里很常见。</p></div><div class="badge">重要推论</div></div><div class="grid-3"><article class="card"><div class="kind theorem">定理</div><h3>调和性</h3><p>若 <span class="math-inline">\(f=u+iv\)</span> 解析，则 <span class="math-inline">\(u\)</span> 与 <span class="math-inline">\(v\)</span> 都满足 Laplace 方程：</p><div class="formula">\[u_{xx}+u_{yy}=0, \qquad v_{xx}+v_{yy}=0\]</div></article><article class="card"><div class="kind definition">定义</div><h3>共轭调和函数</h3><p>若 <span class="math-inline">\(u,v\)</span> 在某区域内具有连续一阶偏导，并满足 C-R 方程，则 <span class="math-inline">\(u+iv\)</span> 在该区域解析；这时常称 <span class="math-inline">\(v\)</span> 是 <span class="math-inline">\(u\)</span> 的一个共轭调和函数。</p></article><article class="card"><div class="kind definition">定义</div><h3>保角映射</h3><p>若 <span class="math-inline">\(f\)</span> 在 <span class="math-inline">\(z_0\)</span> 解析且 <span class="math-inline">\(f'(z_0)\neq 0\)</span>，则它在该点附近保持角度与方向，称为保角。</p></article></div></section>
